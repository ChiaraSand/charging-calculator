// Renault 5 E-Tech charging curve data (400kW charger) - loaded from JSON
let renault5ChargingData = {};
...
// Generate chart data
const chargingPowers = [400, 300, 150, 100, 50, 22, 11]; // This could also be loaded from JSON if needed
